...
To identify where on the genes deleterious stop gains are most often located, the distribution of their relative cDNA position as returned by CADD was plotted using the geom_density function provided by ggplot2.
