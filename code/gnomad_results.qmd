...
#   ggplot(aes(x = relcDNApos, y = phred_bin, colour = flag, fill = flag)) +
...
my_dat <- observed_v_simulated |>
    mutate(phred40 = ifelse(PHRED < 40, "below_40", "above_40")) |>
  mutate(group = paste(flag, PHRED, sep = "_"))

FSA::dunnTest(relcDNApos ~ group,
  data = my_dat,
  method = "holm"
)
